      ...
      <header className="somnus-header">
        ...
        <div className="w-full flex lg:hidden items-center justify-between">
          <button type="button" className="somnus-logo flex items-center cursor-pointer" onClick={() => router.push("/")} aria-label="SOMNUS - Inicio" style={{ animation: 'none' }}>
            <Image src="/assets/SOMNUS LOGO BLANCO.png" alt="SOMNUS" width={140} height={42} className="h-8 w-auto object-contain" priority />
          </button>
          <button
            onClick={() => router.push("/")}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="hidden lg:flex flex-col justify-center space-y-8">
              <div>
                ...
                <div className="mb-6">
                  <Image src="/assets/SOMNUS LOGO BLANCO.png" alt="SOMNUS" width={280} height={84} className="w-48 md:w-64 h-auto object-contain" priority />
                </div>
