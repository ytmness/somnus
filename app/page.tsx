          ...
          {featuredEvent ? (
            <>
              ...
              <div className="flex justify-center mb-4">
                <Image src="/assets/SOMNUS LOGO BLANCO.png" alt="SOMNUS" width={560} height={168} className="w-[28rem] sm:w-[30.8rem] md:w-[39.2rem] lg:w-[44.8rem] h-auto object-contain" priority />
              </div>
