...
import { Calendar, ChevronDown, ChevronUp, Sparkles, HelpCircle } from "lucide-react";
...
import { ORGANIZER_TOUR } from "@/components/onboarding/tours";
...
export default function OrganizadorPageContent() {
  ...
  const tour = useProductTour("organizer");
  ...
  useEffect(() => {
    ...
    if (tabParam === "aprobaciones") setActiveTab("aprobaciones");
  ...
  return (
    <div className="min-h-screen somnus-bg-main text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-10 space-y-8">
        {!hasOrganizer ? (
          ...
          <>
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    onClick={tour.start}
                    className="somnus-nav-link p-1.5 text-white/50 hover:text-white"
            ...
            <div data-tour="org-organizations">
            ...
            <section className="somnus-card p-6" data-tour="org-venues">
              <VenuesManager />
            </section>

            <section className="somnus-card p-6" data-tour="org-team">
            ...
            <section className="somnus-card overflow-hidden" data-tour="org-stripe">
              <button
                type="button"
              ...
              >
                <div>
                  <h2 className="text-xl font-semibold">Set up payments (Stripe)</h2>
                  <p className="text-white/50 text-sm mt-1">
                    {isReady
                      ? "Account connected and ready"
                      : "Optional until you want to charge for events"}
                  </p>
                </div>
                {showPayments ? (
                  <ChevronUp className="w-5 h-5 text-white/50" aria-hidden />
                ) : (
                  <ChevronDown className="w-5 h-5 text-white/50" aria-hidden />
                )}
              </button>
      ...
      <ProductTour
        steps={ORGANIZER_TOUR}
        open={tour.open && !loading && hasOrganizer}
